...
function readOptionalIntegerArray(value: unknown): number[] | null | undefined {
  if (value === null) {
    return null
  }
...
function readOpenAIWSMode(value: unknown) {
  ...
  throw new Error(
    'openaiOAuthResponsesWebSocketV2Mode must be off, ctx_pool, or passthrough.',
  )
}
          ...
          const service = await upsertSub2ApiServiceConfig({
            ...
            refreshTokenPath:
              ...
              body.refreshTokenPath === null
                ...
                : undefined,
            accountsPath:
              typeof body.accountsPath === 'string' ||
              body.accountsPath === null
                ? body.accountsPath
                : undefined,
            clientId:

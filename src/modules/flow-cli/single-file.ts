...
export async function runSingleFileFlow<
  TOptions extends CommonOptions = CommonOptions,
  TResult extends object = object,
>(definition: SingleFileFlowDefinition<TOptions, TResult>, options: TOptions): Promise<TResult> {
  loadWorkspaceEnv();
...
export function runSingleFileFlowFromCli<
  TOptions extends CommonOptions = CommonOptions,
  TResult extends object = object,
>(definition: SingleFileFlowDefinition<TOptions, TResult>, options: TOptions): void {

...
export const PASSWORD_INPUT_SELECTORS: SelectorTarget[] = ['input[type="password"]', 'input[name="password"]'];
...
export const REGISTRATION_EMAIL_SELECTORS: SelectorTarget[] = ['input#email', 'input[name="email"]'];
...
export const AGE_GATE_NAME_SELECTORS: SelectorTarget[] = ['input[name="name"]', 'input#_r_h_-name'];
export const AGE_GATE_AGE_SELECTORS: SelectorTarget[] = ['input[name="age"]', 'input#_r_h_-age', 'input[id*="age"]'];
...
export const ONBOARDING_ACTION_CANDIDATES: Array<{ text: string; selectors: SelectorTarget[] }> = [
  {
...
export function buildExchangeEmail(): { email: string; prefix?: string } {
...
export function summarizePasskeyCredentials(store?: VirtualPasskeyStore): Array<Record<string, unknown>> {
